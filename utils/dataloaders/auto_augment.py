    ...
    def __init__(self):
        self.policies = [
            ...
            [
                ...
                0.7,
                5,
            ],  # changed both shifts from 9 to 5
...
def shear_x(img, magnitude):
    ...
    transform_matrix = np.array(
        [
            [1, random.uniform(magnitudes[magnitude], magnitudes[magnitude + 1]), 0],
            [0, 1, 0],
            [0, 0, 1],
        ]
    )
    ...
    img = np.stack(
        [
            ndimage.interpolation.affine_transform(img[:, :, c], affine_matrix, offset)
...
def posterize(img, magnitude):
    ...
    img = ImageOps.posterize(
        img,
        int(round(random.uniform(magnitudes[magnitude], magnitudes[magnitude + 1]))),
    )
    return img
...
class CIFAR10Policy(object):
    ...
    def __init__(self, fillcolor=(128, 128, 128), magnitude_factor=1):
        ...
        self.policies = [
            SubPolicy(
                0.1, "invert", 7, 0.2, "contrast", 6, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.7, "rotate", 2, 0.3, "translateX", 9, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.8, "sharpness", 1, 0.9, "sharpness", 3, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.5, "shearY", 8, 0.7, "translateY", 9, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.5, "autocontrast", 8, 0.9, "equalize", 2, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.2, "shearY", 7, 0.3, "posterize", 7, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.4, "color", 3, 0.6, "brightness", 7, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.3, "sharpness", 9, 0.7, "brightness", 9, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.6, "equalize", 5, 0.5, "equalize", 1, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.6, "contrast", 7, 0.6, "sharpness", 5, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.7, "color", 7, 0.5, "translateX", 8, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.3, "equalize", 7, 0.4, "autocontrast", 8, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.4, "translateY", 3, 0.2, "sharpness", 6, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.9, "brightness", 6, 0.2, "color", 8, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.5, "solarize", 2, 0.0, "invert", 3, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.2, "equalize", 0, 0.6, "autocontrast", 0, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.2, "equalize", 8, 0.6, "equalize", 4, fillcolor, magnitude_factor
            ),
            SubPolicy(0.9, "color", 9, 0.6, "equalize", 6, fillcolor, magnitude_factor),
            SubPolicy(
                0.8, "autocontrast", 4, 0.2, "solarize", 8, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.1, "brightness", 3, 0.7, "color", 0, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.4, "solarize", 5, 0.9, "autocontrast", 3, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.9, "translateY", 9, 0.7, "translateY", 9, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.9, "autocontrast", 2, 0.8, "solarize", 3, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.8, "equalize", 8, 0.1, "invert", 3, fillcolor, magnitude_factor
            ),
            SubPolicy(
                0.7,
                "translateY",
